        ...
        <div class="row">
            <div class="col-12">
                ...
                <!--    <a href="./project_vote" style="color: black; margin-right: 100px; display: inline-block; font-size: 15px;">
                    ...
                    <input type="hidden" class="form-control" id="PRO_BOARD_CREATER_ID" name="PRO_BOARD_CREATER_ID" value=${id }>
                    <input type="hidden" class="form-control" id="PROJECT_NUM" name="PROJECT_NUM" value=${pNum }>
