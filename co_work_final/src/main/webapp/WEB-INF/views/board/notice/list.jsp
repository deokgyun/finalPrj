...
<style>
    ...
    div > div > table > thead > tr:nth-child(2) > th:nth-child(1) {
        width: 13%
    }

    div > div > table > thead > tr:nth-child(2) > th:nth-child(2) {
        width: 40%
    }

    div > div > table > thead > tr:nth-child(2) > th:nth-child(3) {
        width: 16%
    }

    div > div > table > thead > tr:nth-child(2) > th:nth-child(4) {
        width: 16%
    }

    div > div > table > thead > tr:nth-child(2) > th:nth-child(5) {
        width: 13%
    }
</style>
<title>공지사항</title>
            ...
            <form action="noticeList">
                <div class="search_area">
                    ...
                    <div class="search-button">
                        <button id="search_button" name="search_button" class="btn btn-primary" type="submit">검색
                        </button>
                    </div>
                </div>
            </form>
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach var="b" items="${noticelist}">
                        <tr>
                            ...
                            <td>
                                <div>${b.NOTICE_REG_DATE}</div>
                            </td>
                            <td>
                                <div>${b.NOTICE_READCOUNT}</div>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
