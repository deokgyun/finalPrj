                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="container">
                                    ...
                                    <input type="hidden" name="FREEBOARD_RE_REF"
                                           value="${freeboarddata.FREEBOARD_RE_REF }">
                                    <input type="hidden" name="FREEBOARD_RE_LEV"
                                           value="${freeboarddata.FREEBOARD_RE_LEV }">
                                    <input type="hidden" name="FREEBOARD_RE_SEQ"
                                           value="${freeboarddata.FREEBOARD_RE_SEQ }">
                                    <div class="form-group">
                                        <label for="freeboard_name">글쓴이</label>   <!-- 라벨for 이름과 id가 똑같아야됨-->
                                        <input name="FREEBOARD_NAME" id="freeboard_name" type="text"
                                               class="form-control" value="co-work" readOnly>
                                    </div>
                                    <div class="form-group">
                                        <label for="freeboard_subject">제목</label>   <!-- 라벨for 이름과 id가 똑같아야됨-->
                                        <textarea name="FREEBOARD_SUBJECT" id="freeboard_subject" rows="1"
                                                  class="form-control"
                                                  maxlength="100">Re: ${boarddata.FREEBOARD_SUBJECT }</textarea>
                                    </div>
                                    <div class="form-group">
