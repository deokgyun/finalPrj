                    ...
                    <div class="">
                        <div class="table-responsive">
                            <table
                                ...
                                <thead>
                                <tr>
                                    <th scope="col" style="width: 100px">${listcount } 건</th>
                                ...
                                <c:forEach var="p" items="${projectList }">
                                    <tr>
                                        <c:if test="${p.row_num <= 6 }">
                                            <td><img
                                                    src="${pageContext.request.contextPath }/resources/image/project/img-${p.row_num }.png"
                                                    alt=""
                                                    class="avatar-sm"></td>
                                        </c:if>
                                        <c:if test="${p.row_num > 6  }">
                                            <td><img
                                                    src="${pageContext.request.contextPath }/resources/image/project/img-${p.row_num -6}.png"
                                                    alt=""
                                                    class="avatar-sm"></td>
                                        </c:if>
                                        ...
                                        <td><span class="badge "
                                                  aria-valuenow="${p.project_state }"
                                                  style="width: 50%">${p.project_priority }</span></td>
                                        <td>
                                                                                        ...
                                                                                        <div class="avatar-group-item">
                                                                                            <a href="${pageContext.request.contextPath }/member/mypage_Detail"
                                                                                               class="d-inline-block">
                                                                                                <img
                                                                                                        src="../resources/assets/images/users/${s.USER_IMG }"
                                                                                                        alt=""
                                                                                                        class="rounded-circle"
                                                                                                        style="width: 52px; height: 52px; padding: -5px; margin: 15px;">
                                                                                            </a>
                                                                                            <p id="icon_id"
                                                                                               style="display: none;">${s.USER_ID }</p>
                                                                                            <p id="team_name"
                                                        ...
                                                        <c:if test="${status.index <= 3 }">
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="../resources/assets/images/users/${u.USER_IMG }"
                                                                         alt=""
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <div class="avatar-group-item">
                                                    <!-- 프로필 페이지로 연결 -->
                                                    <a href="javascript: void(0);" class="d-inline-block">
                                                        <img src="../resources/assets/images/users/${p.project_admin_img }"
                                                             alt=""
                                                             class="rounded-circle avatar-xs">
                                                    </a>
